...
list($_b, $_g, $_l) = $template->initialize('1383467498', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lb706c992485_head')) { function _lb706c992485_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lbb6aff2c277_scripts')) { function _lbb6aff2c277_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
