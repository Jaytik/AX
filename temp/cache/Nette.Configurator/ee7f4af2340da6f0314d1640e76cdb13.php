<?php
// source: C:\wampe\www\AX\app/config/config.neon 
// source: C:\wampe\www\AX\app/config/config.local.neon 
...
class SystemContainer extends Nette\DI\Container
{
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => 'C:\\wampe\\www\\AX\\app',
			'wwwDir' => 'C:\\wampe\\www\\AX\\www',
			'debugMode' => TRUE,
			...
			'tempDir' => 'C:\\wampe\\www\\AX\\app/../temp',
		));
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\\wampe\\www\\AX\\app/../temp/cache', $this->getService('nette.cacheJournal'));
		return $service;
	}
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=databaze', 'root', NULL, array('lazy' => TRUE));
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('C:\\wampe\\www\\AX\\app/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Application\PresenterFactory('C:\\wampe\\www\\AX\\app', $this);
	...
	{
		$service = new Nette\Caching\Storages\PhpFileStorage('C:\\wampe\\www\\AX\\app/../temp/cache', $this->getService('nette.cacheJournal'));
